...
The C program prints the first 10 natural numbers using a for loop,
   calculates and displays the factorial of a user-provided number with
   a while loop, and repeatedly shows a menu with a do-while loop until 
