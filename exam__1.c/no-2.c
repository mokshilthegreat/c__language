...
main(){
    ...
    printf("a > b: %d (true)\n", isagreaterthanB);   //  -> 1 if true, 0 if false
    printf("a < b: %d (false)\n", isalessthanB);    //   -> 1 if true, 0 if false

    // -> Logical operators
    int bothpositive = (a > 0) && (b > 0);

    // -> Display results of logical operation
    printf("Both a and b are positive: %d (true)\n", bothpositive);   // -> 1 if true, 0 if false
/*
summary
	
    > The "C" declares two integer variables, performs arithmetic operations 
   ...
   -> It showes the results of all operations.
*/
